...
fpr = pd.read_excel('/Users/jinhaoyu/Downloads/Chinasurfacepcpv2/dataprocess/tigge/BMAresults/ROCAUC/FalsePositiveRate.xlsx', sheet_name=8, header=0)
tpr = pd.read_excel('/Users/jinhaoyu/Downloads/Chinasurfacepcpv2/dataprocess/tigge/BMAresults/ROCAUC/TurePositiveRate.xlsx', sheet_name=8, header=0)
