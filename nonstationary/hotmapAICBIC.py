...
data = pd.read_excel('/Users/jinhaoyu/Downloads/hanjiangdata/non_stationary/resultsProb_RL/modelselect/a57127model.xlsx', sheet_name=2, header=0)
data2 = data.drop('models', axis=1)

x_axis_labels = ['HZ','FP','ZA','SQ','AK','SZ','XX','YX','YUX','FX','LHK','NY','ZY','ZX'] # labels for x-axis
y_axis_labels = ['Model0','Model1','Model2','Model3','Model4','Model5','Model6','Model7','Model8','Model9','Model10','Model11','Model12'] # labels for y-axis
...
plt.yticks(np.arange(13)+0.5,('Model0','Model1','Model2','Model3','Model4','Model5','Model6','Model7','Model8','Model9','Model10','Model11','Model12'),
